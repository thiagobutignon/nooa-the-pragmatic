...
import { extractLinks, validateLink, validateAllLinks } from '../src/validator';
  ...
  - Nested [Link 3](https://link3.com)
    ...
    describe('validateLink', () => {
        ...
        it('should return ok for a successful HEAD request', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith('https://ok.com', expect.objectContaining({ method: 'HEAD' }));
        });

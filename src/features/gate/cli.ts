...
export const gateExamples = [
	{
		input: "nooa gate check --id spec",
		output: "Check if the project meets the defined specifications.",
	},
	{
		input: "nooa gate check --id dogfood --target replay",
		output: "Run dogfooding check on the 'replay' command.",
	},
];

...
`;
    ...
    try {
        ...
        if (values.json) {
            ...
            console.log(result.test.passed ? "✅ Tests passed" : `❌ Tests failed (exit: ${result.test.exitCode})`);
            console.log(result.lint.passed ? "✅ Lint passed" : `❌ Lint failed (exit: ${result.lint.exitCode})`);
